package com.oneHealth.DoctorFees.exception;
...
import com.oneHealth.DoctorFees.DTO.ErrorMessageDTO;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<?> ProfileNotFoundException(FeesNotFoundException ex, WebRequest request) {
